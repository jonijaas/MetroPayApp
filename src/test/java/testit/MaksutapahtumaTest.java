...
class MaksutapahtumaTest {
	...
	void setUp() throws Exception {
		...
		mtapahtuma = new Maksutapahtuma(pvm, 7.40, "01010101", "Viesti", "Kalle Kiireinen", new Tili(), new Tili(), null,
				true);
	}
	...
	void vastaanottajaIbanTest() {
		...
		assertEquals(tili1, mtapahtuma.getVastaanottajaIban(),
				"Maksutapahtuman vastaanottajan IBAN-tunnus ei ollut oikein!");
	}
