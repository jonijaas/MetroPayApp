...
class MaksukontrolleriTest {
	...
	void setUp() throws Exception {
		...
		mtapahtuma = new Maksutapahtuma(9999, LocalDate.of(Calendar.YEAR, Calendar.MONTH, Calendar.DAY_OF_MONTH), 2.00,
				"01010101", "Viesti", "Matti M", tili1, tili2, new Valuutta("EUR", 1.0), true);
	...
	void suoritaMaksuTest() {
		...
		assertEquals(kirjkontrolleri.haeTili("11115555").getSaldo(), maksajanSaldo - 3.50,
				"Maksajan saldo ei vähentynyt oikein.");
		assertEquals(kirjkontrolleri.haeTili("12215555").getSaldo(), vastaanottajanSaldo + 3.50,
				"Vastaanottajan saldo ei noussut oikein.");
