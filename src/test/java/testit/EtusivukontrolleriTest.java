...
/**
 * EtusivukontrolleriTest -luokassa testataan etusivukontrolleriin liittyviä
 * metodeja.
 * 
 * 
 * @author Ryhmä 7
...
class EtusivukontrolleriTest {
	...
	void haeSaldoTest() {
		...
		assertEquals(numberFormat.format(AktiivinenKayttaja.getInstance().getTili().getSaldo()), saldoTxt,
				"Saldon määrä on väärä");
