...
class AktiivinenKayttajaTest {
	...
	void testAsetaMaksu() {
		ak.asetaMaksu(new Maksutapahtuma(9999, LocalDate.of(Calendar.YEAR, Calendar.MONTH, Calendar.DAY_OF_MONTH), 2.00,
				"01010101", "Viesti", "Matti M", new Tili(), new Tili(), new Valuutta("EUR", 1.0), true));
