...
/**
 * MaksuhistoriakontrolleriTest -luokassa testataan maksuhistoriakontrollerin
 * metodeja.
...
class MaksuhistoriakontrolleriTest {
	...
	void tapahtumaListausTest() {
		Maksutapahtuma mtapahtuma = new Maksutapahtuma(99999, pvm, 3.50, "01010101", "Terve", "Pekka P", tili1, tili2, null,
				true);
