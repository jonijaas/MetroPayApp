...
public class ValuuttaDAO {
	...
	/**
	 * 
	 * Hakee https-yhteydellä ulkoisesta url-osoitteesta löytyvästä rajapinnasta
	 * valuuttojen kursseja euroon verrattuna sisältävän JSON-tiedoston.
	...
	public Double haeValuutta(String tunnus) {
		double jsonDouble = 0;
		this.urlString = "NEED URL FOR CURRENCY API" // Url removed
