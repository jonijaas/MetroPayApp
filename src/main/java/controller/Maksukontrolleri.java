...
public class Maksukontrolleri implements IKontrolleri {
	...
	public boolean suoritaMaksu(Tili maksaja, Tili vastaanottaja, double maara, Valuutta valittuValuutta, LocalDate pvm,
	...
	/**
	 * 
	 * asetaSaldo metodi asettaa Aktiivisen käyttäjän valuutan, valuutan symbolin
	 * sekä saldon
	 * näkyville.
	 * 
	 * @param saldo
	...
	/**
	 * 
	 * haeMaksupohjat() metodi hakee aktiivisenkäyttäjän maksupohjat tietokannasta
	 * ja asettaa ne maksupohja valikkoon.
	 * 
	 */
	...
	/**
	 * 
	 * pyydaMaksuPohjaNimi() metodi pyytää käyttäjän syöttämään haluamansa
	 * maksupohjan nimen tekstikenttään, kutsuu
	 * tallennaMaksupohja() metodia, joka tallentaa "nimi" syötteen maksupohjan
	 * nimeksi.
	 * 
	 * @param ae
	 * 
