...
/**
 * 
 * kryptoMyyntiVahvistuskontrolleri luokkassa sijaitsee kaikki kryptovaluutan
 * myynnin vahvistus näkymän metodit ja toiminnot.
 * luokka implementoi Ikontrolleri rajapinnan, sillä se käyttää palaaTakaisin()
 * metodia.
 * 
 * @author Ryhmä 7
 *
...
public class kryptoMyyntiVahvistuskontrolleri implements IKontrolleri {
    ...
    /**
     * 
     * asetaMyyntiTiedot metodi asettaa näkymän label kenttiin ostotapahtuman
     * tiedot.
     * 
     * @param m
     * 
