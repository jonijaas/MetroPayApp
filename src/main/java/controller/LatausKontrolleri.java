...
/**
 * 
 * LatausKontrolleri luokka luotu näyttämään latausruutua sen aikaa kun sovellus
 * lataa tietokannasta tiedot.
 * 
 * * @author Ryhmä 7
 *
 * 
...
public class LatausKontrolleri implements IKontrolleri {
	...
	/**
	 * 
	 * lataaEtusivu() metodi kutsuu GUI:N vaihdaNäkymä metodia, joka vaihtaa
	 * sovelluksen näkymän.
	 * 
	 * @param w
	 * 
