...
public class ValuuttaKontrolleri {
	...
	/**
	 * 
	 * Hakee tietokannan valuutat valuuttaListaan dao:n haeValuutat -metodilla, ja
	 * päivittää niiden kurssit ajantasalla dao:n haeValuutta -metodilla.
	 * 
	...
	/**
	 * 
	 * haeKryptot() hakee valuuttaListasta vain kryptovaluutat ja lisää ne
	 * kryptoListaan.
	 * 
	 * @return kryptoLista.
	 * 
	...
	public ArrayList<Valuutta> haeKryptot() {
		...
		for (int i = 0; i < valuuttaLista.size(); i++) {
			if (valuuttaLista.get(i).getTunnus().equals("BTC") || valuuttaLista.get(i).getTunnus().equals("ADA")
					|| valuuttaLista.get(i).getTunnus().equals("DOGE") || valuuttaLista.get(i).getTunnus().equals("ETH")) {
