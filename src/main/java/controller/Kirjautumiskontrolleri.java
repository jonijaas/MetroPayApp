...
public class Kirjautumiskontrolleri {
	 ...
	 * metodissa kutsutaan alustaTeema() ja alustaKielibox() metodia ja
	 * kielilaatikolle asetetaan onAction metodi.
	 */
	@FXML
	...
	public void alustaTeema() {
		...
		isOn.addListener((observable, dark, color) -> {
			if (color) {
				button.getScene().getRoot().getStylesheets()
						.remove(getClass().getResource("/view/resources/css/style.css").toString());
				button.getScene().getRoot().getStylesheets()
						.add(getClass().getResource("/view/resources/css/color_style.css").toString());
				AktiivinenKayttaja.getInstance().setTeema("COLOR");
				System.out.println("COLOR");

			} else if (dark) {
				button.getScene().getRoot().getStylesheets()
						.add(getClass().getResource("/view/resources/css/style.css").toString());
				button.getScene().getRoot().getStylesheets()
						.remove(getClass().getResource("/view/resources/css/color_style.css").toString());
