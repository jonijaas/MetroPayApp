...
/**
 * Kayttajatiedotkontrollerissa on kaikki omat tiedot näkymään liittyvät metodit
 * sekä toiminnot.
 * 
 * * @author Ryhmä 7
 *
...
public class Kayttajatiedotkontrolleri implements IKontrolleri {
	...
	/**
	 * 
	 * taytaTiedot metodi hakee aktiivisen käyttäjän käyttäjätiedot ja asettaa ne
	 * käyttäliittymä komponentteihin.
	 * 
	 */

	public void taytaTiedot() {
		nimiTxt.setText(AktiivinenKayttaja.getInstance().getAsiakastiedot().getEtunimi() + " "
				+ AktiivinenKayttaja.getInstance().getAsiakastiedot().getSukunimi());
	...
	/**
	 * 
	 * tallennaTiedot metodi muuttaa "tallenna" nappia painamalla, käyttäjän tekemät
	 * käyttäjätietojen muutokset DAOn.
	 * 
	 * @param e
	 * @throws IOException
	 * 
