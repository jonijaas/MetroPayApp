...
/**
 * MaksuVahvistuskontrolleri luokkassa sijaitsee kaikki maksun vahvistus näkymän
 * meotdit ja toiminnot.
...
public class MaksuVahvistuskontrolleri implements IKontrolleri {
	...
	/**
	 * asetaMaksuTiedot metodi asettaa näkymän label kenttiin makstapahtuman m
	 * tiedot.
	 * 
	 * @param m
	 */
