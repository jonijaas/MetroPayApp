...
/**
 * Etusivukontrollerissa on kaikki etusivu näkymään liittyvät metodit sekä
 * toiminnot.
 * 
 * * @author Ryhmä 7
 *
...
public class Etusivukontrolleri {
	...
	/**
	 * uusiMaksu metodi kutsuu gui:n vaihdanäkymä metodia, joka vaihtaa sovelluksen
	 * näkymän.
	 * 
	 * @param e
	 * @throws IOException
	...
	/**
	 * tilihistoria metodi kutsuu gui:n vaihdanäkymä metodia, joka vaihtaa
	 * sovelluksen näkymän.
	 * 
	 * @param e
	 * @throws IOException
	...
	/**
	 * tiedot metodi kutsuu gui:n vaihdanäkymä metodia, joka vaihtaa sovelluksen
	 * näkymän.
	 * 
	 * @param e
	 * @throws IOException
	...
	/**
	 * kirjauduUlos metodi kutsuu gui:n vaihdanäkymä metodia, joka vaihtaa
	 * sovelluksen näkymän.
	...
	public void tarkistaMaksut() {
		ArrayList<Maksutapahtuma> maksut = dao.haeOdottavatMaksut(AktiivinenKayttaja.getInstance().getTili().getIban(),
				LocalDate.now());
