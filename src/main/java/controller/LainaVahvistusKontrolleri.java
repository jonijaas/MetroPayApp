...
public class LainaVahvistusKontrolleri implements IKontrolleri {
	...
	/**
	 * palaaTakisin metodi kutsuu gui:n vaihdanäkymä metodia, joka vaihtaa
	 * sovelluksen näkymän.
	 * 
	 * @param e
	 * @throws IOException
	...
	/**
	 * initialize metodi ajetaan heti näkymän avautumassa. Hakee numeroformaatin ja
	 * kutsuu asetaLainaTiedot metodia.
	 */
	@FXML
	void initialize() {
